...
#GUI Variables
$FormTitleText = "జిమ్ టైలర్ ద్వారా డిస్క్ క్లీనర్ (PowerShellEngineer.com)"
$SelectDiskLabelText = "డిస్క్‌ని ఎంచుకోండి:"
$FreeSpaceLabelText = "ఫ్రీ స్పేస్ (గిగాబైట్లు): "
$TotalSpaceLabelText = "మొత్తం స్థలం (గిగాబైట్లు): "
$JunkFoundLabelText = "జంక్ కనుగొనబడింది (గిగాబైట్లు):"
$CleanDiskBtnText = "డిస్క్‌ను క్లీన్ చేయండి *ఫైళ్లను తొలగించండి*"
$SpaceCleanedLabelText = "క్లీన్డ్ స్పేస్ (గిగాబైట్లు): "
$LogFileLabelText = "లాగ్ ఫైల్ కనుగొనబడింది: $abcdefg"
$CreditLabelText = "జిమ్ టైలర్ ద్వారా స్క్రిప్ట్ - PowerShellEngineer.com"
$LogFileLocatedText = "లాగ్ ఫైల్ కనుగొనబడింది"
$AnalyzingDriveText = "డ్రైవ్‌లను విశ్లేషిస్తోంది..."
$BrowsersAreRunningText = "బ్రౌజర్‌లు రన్ అవుతున్నాయి... వినియోగదారుకు తెలియజేయి..."
$PleaseCloseBrowsersText = "దయచేసి అన్ని వెబ్ బ్రౌజర్‌లను మూసివేసి, మళ్లీ ప్రయత్నించండి."
$CleaningDriveText = "డ్రైవ్ క్లీనింగ్..."
